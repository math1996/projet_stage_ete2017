...
set_property edif_top_file "C:/Users/mathieu/Desktop/projet_stage_ete2017/modules_controle_board/top_test_PID.ngc" [ get_property srcset [ current_run ] ]
...
set_property target_constrs_file "top_test_PID.ucf" [current_fileset -constrset]
add_files [list {top_test_PID.ucf}] -fileset [get_property constrset [current_run]]
link_design
